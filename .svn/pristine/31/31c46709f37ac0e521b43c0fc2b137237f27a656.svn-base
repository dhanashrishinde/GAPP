					...
					<div class="panel"
						...
						<c:choose>
								...
								<div class="panel-body">
									<form:form modelAttribute="addInfoValue"
										...
										<c:set var="flag" value="false"></c:set>
											<c:forEach items="${addInfos}" var="addInfo">
												<tr>
													...
													<c:choose>
														...
														<td><form:input path="field_value"
																	class="form-control"  id="fieldVal" />
																	<font color=red><span id="notNumber"></span></font></td>
														</c:when>
														<c:otherwise>
															<td><form:input path="field_value"
											...
											<%-- <tr>
												<td><form:input path="field_value" class="form-control" /></td>
											</tr> --%>
										</table>
							...
							<c:otherwise>
								...
								<a href="addRecords.html?app_id=${app.id}" class="btn btn-primary btn-lg "> <b>
										Next </b>
								</a>
							</c:otherwise>
						</c:choose>
