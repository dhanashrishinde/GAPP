	...
	<center>
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav" style="background-color: #B95835">
				<li class="active"><a href="/gapp/user/staffManagement.html" style="color: #EECD86"><span
		...
		<h1 style="color: #E18942">
			<b>Graduate Program Applications<small> CS520 </small></b>
		</h1>
		<div class="container">
			<h2>
				<a href="list.html">Student Details</a>
			</h2>
		</div>
		</center>
</body>
