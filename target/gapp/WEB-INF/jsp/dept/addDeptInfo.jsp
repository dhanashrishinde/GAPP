						...
						<div class="panel-body">
							...
							<form:form modelAttribute="deptInfo">
								...
								<div class="form-group form-inline">
									...
									<form:radiobutton path="field_type" value="String"
										class="form-control" />
									String
									<form:radiobutton path="field_type" value="Number"
										class="form-control" />
									Number
									<form:radiobutton path="field_type" value="File"
										class="form-control" />
									File
								</div>
								<br/>
